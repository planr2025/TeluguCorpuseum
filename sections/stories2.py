...
POSTS_FILE = os.path.join(SECTION_DIR, "posts.json")
...
def load_posts(section=SECTION):
    path = os.path.join(DATA_DIR, section, "posts.json")
...
def write_story_form():
    ...
    with st.container():
        # Add a placeholder to insert custom div
        ...
        with placeholder.container():
            ...
            #     "📖 Your Story", height=200, placeholder="Write your story here..."
            # )
...
def my_stories_view():
    ...
    for post in my_posts:
        ...
        short_desc = " ".join(post['description'].split()[:25]) + "..."  # Approx. 3 lines
